package com.ten.tencloud.widget.blur;
...
//            overlay = FastBlur.doBlur(overlay, (int) BLUR_RADIUS, true);
    ...
    public static void snapShotWithoutStatusBar(Activity activity) {
        ...
        try {
            ...
            int width = UiUtils.getScreen(activity).widthPixels;
            int height = UiUtils.getScreen(activity).heightPixels;
