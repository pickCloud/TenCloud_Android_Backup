...
public class MenuItem extends FrameLayout {
    ...
    private void intiView(Context context) {
        ...
        //加载布局
        mRootView = LayoutInflater.from(context).inflate(R.layout.nav_layout_item_menu, this, false);

        ivIcon = mRootView.findViewById(R.id.iv_icon);
        tvText = mRootView.findViewById(R.id.tv_text);
        tvUnReadNum = mRootView.findViewById(R.id.tv_unred_num);
        tvRedPoiont = mRootView.findViewById(R.id.tv_point);
        addView(mRootView);
    }
