...
public class ProgressSemiCircleView extends View {
    ...
    public ProgressSemiCircleView(Context context) {
        this(context, null);
    }

    public ProgressSemiCircleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ProgressSemiCircleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mRectF.bottom = getHeight() * 2 - mStrokeWidth;
        canvas.drawArc(mRectF, -180, 180, false, mPaint);
        //绘制实际进度
        mPaint.setColor(mColor);
        canvas.drawArc(mRectF, -180, 180 * (mProgress / 100f), false, mPaint);
    }
