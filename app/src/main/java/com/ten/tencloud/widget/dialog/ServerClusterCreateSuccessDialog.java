...
public class ServerClusterCreateSuccessDialog extends Dialog {

    public ServerClusterCreateSuccessDialog(@NonNull Context context, OnBtnListener onBtnListener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setContentView(R.layout.dialog_server_cluster_create_success);
