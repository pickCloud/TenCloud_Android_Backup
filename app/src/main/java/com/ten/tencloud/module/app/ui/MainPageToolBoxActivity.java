...
public class MainPageToolBoxActivity extends SupportBlurDialogFragment implements ApplicationDelContract.View {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.activity_main_toolbox, null);
        view.findViewById(R.id.btn_tool1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), AppAddActivity.class);
